...
if st.session_state.page == "Welcome":
    ...
    if submitted:
        premium = 5000 + (age * 80) + (bmi * 150) + (children * 500) + (7000 if smoker == "Yes" else 0) + (3000 if drinker == "Regularly" else 0)
        ...
        with col1:
            ...
            # Interactive Chart
            breakdown = pd.DataFrame({"Category": ["Base", "Age", "Lifestyle", "Children"], "Value": [5000, age*80, 5000, children*500]})
